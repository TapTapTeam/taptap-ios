...
/// 중간 크기의 macOS용 CTA 버튼입니다.
///
/// 아이콘과 텍스트를 함께 표시하며, 버튼 variant와 상태(hover, disabled)에 따라
/// 스타일이 변경됩니다.
///
/// 주요 액션, 보조 액션, 위험 액션 등 다양한 CTA 시나리오에 사용할 수 있습니다.
///
/// ```swift
/// MacMediumCTAButton(title: "저장") {
///   print("Tapped")
/// }
///
/// MacMediumCTAButton(title: "보관", variant: .gray) {
///   print("Tapped")
/// }
///
/// MacMediumCTAButton(title: "삭제", variant: .danger) {
///   print("Tapped")
/// }
///
/// MacMediumCTAButton(title: "닫기", variant: .white) {
///   print("Tapped")
/// }
/// .disabled(true)
/// ```
...
public struct MacMediumCTAButton: View {
...
// MARK: - View
public extension MacMediumCTAButton {
  var body: some View {
    Button {
      onTap()
    } label: {
...
// MARK: - Private
private extension MacMediumCTAButton {
  ...
  var backgroundColor: Color {
    ...
    case .danger:
      if !isEnabled { return .n40 }
      return effectiveHovered ? .danger.opacity(0.22) : .danger.opacity(0.12)
  ...
  var foregroundColor: Color {
    ...
    case .danger:
      return isEnabled ? .danger : .caption2
...
// MARK: - Preview
private struct MacMediumCTAButtonPreview: View {
  var body: some View {
    VStack(alignment: .leading, spacing: 20) {
      
      // MARK: - Primary
      HStack(spacing: 12) {
        MacMediumCTAButton(title: "타이틀", variant: .primary) {
          print("Primary 기본")
        }
      ...
      // MARK: - Gray
      HStack(spacing: 12) {
        MacMediumCTAButton(title: "타이틀", variant: .gray) {
          print("Gray 기본")
        }
      ...
      // MARK: - Danger
      HStack(spacing: 12) {
        MacMediumCTAButton(title: "타이틀", variant: .danger) {
          print("Danger 기본")
        }
      ...
      // MARK: - White
      HStack(spacing: 12) {
        MacMediumCTAButton(title: "타이틀", variant: .white) {
          print("White 기본")
        }
