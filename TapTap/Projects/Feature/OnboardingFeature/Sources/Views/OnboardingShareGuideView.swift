//
//  OnboardingShareGuideView.swift
//  Feature
//
...
public struct OnboardingShareGuideView {
  public let store: StoreOf<OnboardingShareGuideFeature>
  
  @State private var isReady: Bool = false
  
  public init(store: StoreOf<OnboardingShareGuideFeature>) {
    self.store = store
  }
}

extension OnboardingShareGuideView: View {
