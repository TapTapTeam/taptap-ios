...
public struct OnboardingShareView {
  public let store: StoreOf<OnboardingShareFeature>
  
  public init(store: StoreOf<OnboardingShareFeature>) {
    self.store = store
  }
}

extension OnboardingShareView: View {
